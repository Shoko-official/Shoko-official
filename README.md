I'm an enthusiastic student with a deep passion for Machine Learning, Data Science, and low-level programming. I love building things from absolute scratch to truly understand how they work under the hood. I usually code on my own, since i'm autistic and think differently, it can sometimes be hard to work in a team, but the difference can also be a wonderfull strength and i'd be more than happy to work with you and contribute to your projects.
...
- **Python**: For rapid prototyping, Neural Networks, Pygame, and data engineering and it's richness of libraries.
